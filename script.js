...
function writePassword() {
    var correctPrompts = getPrompts();  //either true of false
...
function generatePassword() {
  //I would like generatePassword based on prompts
  var password = "";
...
function getPrompts(){
  ...
  if (confirm("Would you like special characters in your password")) {
    choiceArr = choiceArr.concat(speacialCharArr);
  }
